...
def loss_symmetry (coords, thetas):
    ...
    r_y = torch.autograd.grad(r, y, torch.ones_like(r), create_graph=True)[0]
...
if __name__ == '__main__':
    ...
    # Prepare logging
    checkpoint_file = open(f'./detached/pinn_viscosity_neumann.p', 'ab')
