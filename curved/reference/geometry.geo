...
Line(8) = {7, 1};
//+
Transfinite Line {3} = 200 Using Progression 1.005;
//+
Transfinite Line {8,5} = 200 Using Progression 0.995;
//+
Transfinite Line {2} = 80 Using Progression 1.02;
//+
Transfinite Line {6} = 80 Using Progression 0.98;
//+
Transfinite Line {1,7} = 320 Using Progression 1.0;//+
